...
func handleFollowRequest(db *sql.DB) http.Handler {
	type request struct {
...
func handleFollowAccept(db *sql.DB) http.Handler {
	type request struct {
...
func handleFollowRefuse(db *sql.DB) http.Handler {
	type request struct {
		RequesterID int64 `json:"requester_id"`
	}
...
func handleFollowUnfollow(db *sql.DB) http.Handler {
	type request struct {
		TargetID int64 `json:"target_id"`
	}
...
func handleProfileRelations(db *sql.DB) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
...
func currentUserFromContext(r *http.Request) (userProfile, bool) {
